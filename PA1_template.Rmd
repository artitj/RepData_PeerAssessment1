...
There are `r numNA` rows with NA steps.

Since the NAs may introduce a bias into some of the data analysis, the NAs will be replaced with the mean for the time interval.
...
The number of mean steps per day was `r format(meanImpSteps, nsmall=2, scientific=F)` and the median was `r medianImpSteps`.
